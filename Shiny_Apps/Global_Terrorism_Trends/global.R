...
names(International) = c("Ideologically International (Perpetrator Nationality Vs. Victim Nationality)", "Logistically International (Perpetrator Nationality Vs. Location)", "Other International (Location Vs. Victim Nationality)")
